...
public final class Item1Binding implements ViewBinding {
  ...
  private Item1Binding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout cardview,
  ...
  @NonNull
  public static Item1Binding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static Item1Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
  ...
  @NonNull
  public static Item1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Item1Binding((ConstraintLayout) rootView, cardview, doctorName, passOrfail,
