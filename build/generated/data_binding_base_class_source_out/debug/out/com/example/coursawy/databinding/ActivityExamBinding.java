...
public final class ActivityExamBinding implements ViewBinding {
  ...
  private ActivityExamBinding(@NonNull RelativeLayout rootView, @NonNull Button addTestBtn,
  ...
  public static ActivityExamBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityExamBinding((RelativeLayout) rootView, addTestBtn, offlineBtn, onlineBtn);
    }
